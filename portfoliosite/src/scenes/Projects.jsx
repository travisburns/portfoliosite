...
const Projects = () => {
  return (
    ...
    <section id="projects" className="pt-48 pb-48 z-[12] relative bottom-[1500px]">
      <div className="projects-title w-[90vw]  mr-[5vw] pb-[12rem]">
      ...
      <div className="item-container w-[100%] text-[.65em]">
        <div className="item-info">
          <div className="item-image-container relative">
            <div className="item-img h-[150px] xs:h-[200px] sm:h-[250px] relative">
              ...
              <div className="item-desc relative m-[0 0 2.5em] text-[0.9rem] leading-[1.3em] text-left font-playfair text-black bottom-[-1rem] xs:bottom-[2rem]  sm:bottom-[5rem]">
              ...
              <div className="project-arrow relative top-[7rem] left-[2rem]">
                ...
                <img src={github} alt="" className="absolute right-[22px] bottom-[60px] w-[2em] h-[2em]" />
              </div>
