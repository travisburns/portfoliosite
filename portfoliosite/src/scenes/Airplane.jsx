...
Command: npx gltfjsx@6.2.3 src/assets/airplane/model.glb
*/
...
export function Airplane(props) {
  const { nodes, materials } = useGLTF('src/assets/airplane/model.glb')
  return (
...
useGLTF.preload('src/assets/airplane/model.glb')
